...
#'   \item{RudeToMoveToUnsoldSeat}{Is itrude to move to an unsold seat on a plane?}
#'   \item{RudeToTalkToNeighbor}{Generally speaking, is it rude to say more than a few words tothe stranger sitting next to you on a plane?}
...
#'   \item{RudeToRecline}{Is itrude to recline your seat on a plane?}
...
#'   \item{RudeToBringBaby}{In general, is itrude to bring a baby on a plane?}
