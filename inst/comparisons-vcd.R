...
## using the respective hues from a color wheel with chroma = 60 and luminance = 75
...
employment$EmploymentLength <- gsub("-", "h", employment$EmploymentLength)
#employment$EmploymentLength <- gsub("<", "l", employment$EmploymentLength)
#employment$EmploymentLength <- gsub(">", "g", employment$EmploymentLength)
