...
This repo is a fork of the `ggmosaic` package, no longer on CRAN and not maintained. 
...
The current goal is to make this useful again and extend it by allowing fitted loglinear models which can be used to
