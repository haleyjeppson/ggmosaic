...
```{r happy-order, message=FALSE, fig.width = 8, fig.height = 3.5}
...
```{r conditioning, message=FALSE, fig.width = 8, fig.height = 3.5}
...
```{r conditioning-facet-1, message=FALSE}
...
```{r conditioning-facet-2, message=FALSE}
