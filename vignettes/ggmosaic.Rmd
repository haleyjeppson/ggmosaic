...
ggplot(data = titanic) +
  geom_mosaic(aes(weight = Freq, vars = interaction(Class), group = 1))
ggplot(data = titanic) +
  geom_mosaic(aes(weight = Freq, vars = interaction(Class), group = 1), divider = "hspine")
ggplot(data = titanic) +
  geom_mosaic(aes(weight = Freq, vars = interaction(Class), group = 1), divider = "hbar")
ggplot(data = titanic) +
  geom_mosaic(aes(weight = Freq, vars = interaction(Class), group = 1), divider = "vbar")
```
...
ggplot(data = titanic) +
  geom_mosaic(aes(weight = Freq, fill = Survived, vars = interaction(Class, Sex), group = 1), divider = c("hspine", "vspine", "hspine"))
```
